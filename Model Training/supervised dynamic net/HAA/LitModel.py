...
class LitModel(pl.LightningModule):
    def __init__(self, frames_dir, model_id, lr, momentum, weight_decay, lr_steps=[100, 200]):
        super().__init__()
        self.model = FlowOnlyClassifier(model_id,
                                        feafa_architecture.TinyMotionNet(),
                                        flow_resnet.flow_resnet18(pretrained=True, num_classes=500))
        
        self.criterion = nn.CrossEntropyLoss()
        self.all_labels = self.get_all_labels(frames_dir)
