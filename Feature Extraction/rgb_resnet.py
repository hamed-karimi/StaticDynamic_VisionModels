...
def rgb_resnet18(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        ###
        weights['fc_action.weight'] = weights.pop('fc.weight')
        weights['fc_action.bias'] = weights.pop('fc.bias')
        weights['fc_action.weight'].data = weights['fc_action.weight'].data[:model.fc_action.out_features, :]
        weights['fc_action.bias'].data = weights['fc_action.bias'].data[:model.fc_action.out_features]
        ###
