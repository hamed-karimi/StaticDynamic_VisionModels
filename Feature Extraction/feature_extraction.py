...
modules_of_interest = ['videomae.encoder.layer.0.output',
                       'videomae.encoder.layer.1.output',
                       'videomae.encoder.layer.2.output',
                       'videomae.encoder.layer.3.output',
                       'videomae.encoder.layer.4.output',
                       'videomae.encoder.layer.5.output',
                       'videomae.encoder.layer.6.output',
                       'videomae.encoder.layer.7.output',
                       'videomae.encoder.layer.8.output',
                       'videomae.encoder.layer.9.output',
                       'videomae.encoder.layer.10.output',
                       'videomae.encoder.layer.11.output',
                       'fc_norm']
